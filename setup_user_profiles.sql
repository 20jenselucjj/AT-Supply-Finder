-- Run this SQL in your Supabase SQL Editor to set up user profiles
-- This will allow the user management to show real user data
...
-- Insert current user profiles for existing users
INSERT INTO public.user_profiles (id, email, last_sign_in_at, created_at)
SELECT 
  id, 
  email, 
  last_sign_in_at,
